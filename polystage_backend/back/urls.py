...
urlpatterns = [
    ...
    path('sendCodeMail/', views_login.SendCodeEmail.as_view()),
    path('logout/', views_login.Logout.as_view(), name='custom_logout'),
    path('verifyCode/', views_login.verifyCode.as_view()),
    ...
    path('manageJuryMembreJury/', views_jury.manageJuryMembreJury.as_view()),
